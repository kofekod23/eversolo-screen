...
- `ir_remote.py` : demon qui traduit n'importe quelle telecommande infrarouge en commandes Eversolo (lecture, pause, piste, volume, muet), avec appairage par apprentissage sur `/remote`. Details dans [INSTALL.md](INSTALL.md).
